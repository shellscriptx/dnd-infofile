...
# Yad está instalado?
[ -x "$(which yad)" ] || { echo "$(basename "$0"): error: 'yad' não está instalado." 1>&2; exit 1; }
...
wget https://raw.githubusercontent.com/shellscriptx/dns-infofile/master/ask.png -O /tmp/ask.png /tmp &>/dev/null
